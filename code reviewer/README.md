# CodePlus-AI Reviewer Engine

**Backend engine for CodePlus-AI: AI-powered code review with build validation**
...
| `make run-forever` | Scans the entire repository directory-by-directory |
| `make report` | Generates a professional HTML report |
| `make test` | Run tests |
